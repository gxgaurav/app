function getUsernameFromLocalStorage() {
  return localStorage.getItem('fx_local');
}
...
function fetchUserCoins(username) {
  ...
  const url = 'https://script.google.com/macros/s/AKfycbwqaBnMKUBgfzWYxCXyF11UTK-iXhaB0oKkkvN_eV0bEC-BPGyanc9tSngJDEkS6mig/exec';
